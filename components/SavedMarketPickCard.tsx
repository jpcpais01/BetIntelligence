...
export default function SavedMarketPickCard({
  ...
  return (
    <div className="pop-in rounded-2xl border p-4" style={{ borderColor: "var(--d-border)", background: "var(--d-surface)" }}>
      <div className="mb-2.5 flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="press -mr-1 shrink-0 rounded-full p-1.5 text-text-faint hover:bg-white/5"
        >
      ...
      <div className="mb-3 grid grid-cols-3 gap-1.5">
        {pick.independent.outcomes.slice(0, 3).map((o) => {
          ...
          return (
            <div key={o.label} className="rounded-xl px-2 py-2 text-center" style={{ background: "var(--d-surface-2)" }}>
      ...
      {bestEdge ? (
        ...
        <div className="flex items-center gap-2 rounded-xl px-3 py-2" style={{ background: "var(--d-surface-2)" }}>
